...
checkSearchTime(matrixArray(50, 50, -250, 1001), SelectionSort, 'selectionsort')
checkSearchTime(matrixArray(50, 50, -250, 1001), InsertionSort, 'insertionsort')
checkSearchTime(matrixArray(50, 50, -250, 1001), BubbleSort, 'bubblesort')
checkSearchTime(matrixArray(50, 50, -250, 1001), ShellSort, 'shellsort')
checkSearchTime(matrixArray(50, 50, -250, 1001), QuickSort, 'quicksort')
checkSearchTime(matrixArray(50, 50, -250, 1001), HeapSort, 'heap sort')
checkSearchTime(matrixArray(50, 50, -250, 1001), IncludeSort, 'includesort')
checkSearchTime(matrixArray(50, 50, -250, 1001), TournamentSort, 'tournamentsort')
